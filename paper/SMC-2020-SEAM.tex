...
The first-order cardioid microphone could be described as balanced sum of non-directional pressure variations
...
The typical patterns are produced with the following balancing between non-directional pressure and bidirectional pressure gradient.
...
The Mid signal could be expressed by formula
...
The Faust code for a Mid-Side panner is truly self-explainable: the straight equations to describe both cardioid and figure-8 are the two components at the out of panning. 
%--------------------------------------------
%----------------larghezza massima del codice
\begin{lstlisting}
mspan(x,p,rad) = m,s
