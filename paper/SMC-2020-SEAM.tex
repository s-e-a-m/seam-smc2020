...
Michael Gerzon, in the seventies, from the roots of the Blumlein “era” jumped the line with dozen of clear descriptions about perception and technology of reproduction.
...
Michael Gerzon draws a schematic representation of different loudspeaker position for multispeaker stereo from one to five:

\begin{quotation}
\ldots we show the loudspeaker layouts considered for frontal stage stereo using from one (regarding mono as the trivial case of “one-loudspeaker stereo”!) to five loudspeakers… \cite{mg92pdmsss}
\end{quotation}

Is there a one-loudspeaker stereo condition? Truly yes.

A loudspeaker in condition to play itself, not reproducing something of acoustic real but reproducing, for example, a sound that not could live without a loudspeaker represents a stereo condition. A Butterworth filtered pink noise monophonically singing in a room is a condition of stereophony.
